...
module.exports = {
  ...
  actions: (data) => {
    ...
    const actions = [
      ...
      {
        type: 'add',
        path: `../src/components/${data.type}/{{properCase name}}/index.stories.js`,
        templateFile: './components/add/stories.hbs'
      },
      {
        type: 'add',
        path: `../src/components/${data.type}/{{properCase name}}/__tests__/index.js`,
        templateFile: './components/add/test.hbs'
      },
      {
        type: 'modify',
